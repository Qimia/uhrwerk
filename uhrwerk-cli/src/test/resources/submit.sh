...
/home/falk/Documents/spark-2.4.4-bin-hadoop2.7/bin/spark-submit \
  ...
  --master local[*] \
  /home/falk/IdeaProjects/uhrwerk/uhrwerk-cli/target/uhrwerk-cli-0.1.0-SNAPSHOT.jar \
  ...
  -t "../uhrwerk-example/src/main/resources/retail_examples/staging.retail/productDimApp_1.0.yml" \
