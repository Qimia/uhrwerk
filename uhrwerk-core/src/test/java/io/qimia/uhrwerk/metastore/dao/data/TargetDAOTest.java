package io.qimia.uhrwerk.metastore.dao.data;

import io.qimia.uhrwerk.metastore.dao.config.ConnectionDAO;
import io.qimia.uhrwerk.metastore.dao.config.TableDAO;
import io.qimia.uhrwerk.metastore.model.BatchTemporalUnit;
import io.qimia.uhrwerk.metastore.model.config.Table;
import io.qimia.uhrwerk.metastore.model.data.Target;
...
class TargetDAOTest {
  ...
  void save() throws SQLException {
    ...
    io.qimia.uhrwerk.metastore.model.config.Connection conn =
        new io.qimia.uhrwerk.metastore.model.config.Connection();
