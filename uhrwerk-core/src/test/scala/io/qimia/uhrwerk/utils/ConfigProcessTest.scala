...
class ConfigProcessTest extends AnyFlatSpec {
  ...
  "given a global & step config with missing connection-name it" should "not validate the combination" in {
    ...
    val sourceA = new Source
    sourceA.setFormat("a/b/c.parquet")
